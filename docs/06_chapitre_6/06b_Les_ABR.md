...
## <a name="_toc149153662"></a>**1. Introduction**
...
## <a name="_toc149153663"></a>**2. Définition**
...
## <a name="_toc149153664"></a>**3. Est-ce performant ?**
...
## <a name="_toc149153665"></a>**4. Exemples**
...
**Activité n° 1 :**  **Séquence dans un arbre binaire de recherche :** Quelle est la séquence associée à l’arbre binaire de recherche ci-dessous ?

![](Aspose.Words.6e55a686-622e-41c3-8254-4f896d64da0f.009.png){: .center }

**Activité n° 2 :**  **Reconnaitre un arbre binaire de recherche** 

![](Aspose.Words.6e55a686-622e-41c3-8254-4f896d64da0f.010.png){: .center }

**Activité n° 3 :**  **Construire un arbre binaire de recherche** Un vétérinaire voudrait stocker les fiches médicales de ses patients, et, plutôt que d'utiliser un tableau ou une liste, on se propose d'utiliser un arbre binaire. La fiche contiendra différentes informations sur l'animal ; on utilisera son nom comme clé (c'est-à-dire comme critère pour la relation d'ordre), que l'on triera selon l'ordre alphabétique croissant. Le vétérinaire reçoit sa première patiente, qui répond au nom de Gaufrette. Comme sa fiche sera le premier nœud de notre arbre, elle en devient automatiquement la racine. Puis le vétérinaire reçoit les animaux dans l’ordre suivant afin de les soigner : Charlie, Médor, Flipper, Bubulle et Augustin


**Activité n° 4 :**  **Construire un arbre binaire de recherche** Imaginons que la séquence soit maintenant la suivante : {Gaufrette, Charlie, Médor, Flipper, Augustin, Bubulle}, c’est-à-dire que Augustin soit arrivé au rendez-vous médical avant Bubulle. L’arbre binaire de recherche est-il encore le même ? Quelle conclusion peut-on en tirer ?

La valeur la plus à **gauche** correspond au **minimum** de l’ABR. Et la valeur la plus à **droite** correspond au **maximum** de l’ABR.


## <a name="_toc149153666"></a>**5. Les algorithmes et les implémentations en Python**
### <a name="_toc149153667"></a>**5.1. Créer un ABR** 
...
**Activité n° 5 : Création d’un ABR** : Implémenter ce script dans un fichier que l’on nommera ABR
```python
class Node:
...
### <a name="_toc149153668"></a>**5.2. ❤️Insérer dans un ABR ❤️**
...
**Activité n° 6 : Insertion dans un ABR** Créer la **fonction** inserer(T, data)qui répond à l’algorithme précédent

**Activité n° 7 : Insertion dans un ABR** Créer la **méthode** insert(self, data) à la classe Node 


La fonction inserer et la méthode insert sont équivalent car elles permettent de construire l’ABR.

**Activité n° 8 : Représentation graphique de l’arbre** importer le fichier graphicarbre.py au script précédent pour visualiser l’arbre binaire de recherche 
```python
from graphicarbre import *
```


**Activité n° 9 : Représentation graphique de l’arbre** Tester le programme précédent avec 
```python
...
### <a name="_toc149153669"></a>**5.3. ❤️Recherche d’une clé dans un ABR❤️**
...
**Activité n° 10 : Recherche dans un ABR** : Créer une **fonction** rechercher(T, cle) qui répond à l’algorithme précédent mettre la représentation graphique en commentaire

Tester la avec la valeur 7 et la valeur 188.


**Activité n° 11 : Recherche dans un ABR** : Créer une **méthode** search à la classe Node mettre la représentation graphique en commentaire

Tester la avec la valeur 7 et la valeur 188.


### <a name="_toc149153670"></a>**5.4. Parcours infixe**

**Activité n° 12**** : parcours infixe : Créer une fonction parcours\_infixe(T) 

Tester la sur les 2 arbres. Que remarquez vous ?



## <a name="_toc149153671"></a>**6. Exercices**
...
## <a name="_toc149153672"></a>**7. Projet** 
...
9\. Ajouter une méthode publique search() qui recherche une clef dans l’arbre et retourne True si la clef est trouvée, False sinon.
...
5\. Comment obtenir la valeur associée à la clé "Attack" pour l'enregistrement d'index 0 contenus dans pokemons ?
...
8\. Dessiner sur papier l'arbre créer en utilisant la fonction de test de création suivante
```python
def creation_test():
...
>>> print(arbre)
```
9\. Rajoutons un noeud dont la clé est 21. Vérifier qu'il se positionne bien en affichant l'arbre.
```
...
11\. Utiliser le jeu de commandes suivants pour comprendre de le principe :
```
>>> collect = creation_cp()
>>> len(collect)
800
...
14\. Utilisez les commandes suivantes pour réopndre aux questions :
...
15\. Ouvrir le module **abr.py**. Retrouver un algorithme permettant de rechercher un noeud dans un ABR en utilisant **les fonctions d'interface du module**. Une fois l'algorithme retrouvé, implémenter le dans la fonction recherche.

Renvoyer la valeur au lieu de True

16\. Tester l'absence d'erreur en lançant directement le module abr.py. Vérifiez ensuite que la fonction fonctionne : relancer le programme **arbre\_pokemons.py** puis lancer ces commandes :
```
>>> aap = creation_aap()
>>> print(aap)
>>> recherche(aap, 49)
...
18\. Modifier **parcours\_infixe** : il faudra afficher également le nom du Pokemon à côté de son score d'attaque.
...
19\. A droite toute : rajouter dans le programme arbre\_pokemon la fonction récursive cle\_max : on transfère la plus grande valeur à chaque appel !
```python
...
20\. A gauche toute : créer dans le programme arbre\_pokemon la fonction récursive cle\_min : on transfère la plus petite valeur à chaque appel !
