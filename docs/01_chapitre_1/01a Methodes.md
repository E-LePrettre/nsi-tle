...
### Fiche Méthode pour Réussir en Spécialité NSI en Première
...
- **https://fr.futurecoder.io/ :** Cours interactifs en Python
- **http://www.france-ioi.org/ :** Créer un compte avec un pseudo du type : prenom.nom. A gauche choisir groupe et classe > Rejoindre un groupe > **NSI JC**, Mdp : cassaigne40280, Faire les exercices : **http://www.france-ioi.org/algo/chapters.php?progression=1**
...
- **Sur le site de la prof** :Vous trouverez tous les exercices pour le programme de première : **http://elisa.leprettre.free.fr/NSI/NSI_exos/co/page_accueil.html**
