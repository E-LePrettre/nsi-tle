...
Annexe  :  représentation graphique  de  la  fonction f(x)= 27x^3 -27x^2 - 

18^x  +8 (graphique  réalisé  avec  la  librairie[ matplotlib ](http://matplotlib.org/examples/pylab_examples/axes_props.html)de  Python)  
